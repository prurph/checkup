class Tag < ActiveRecord::Base
  ...
  def self.handleRoutine(tag_to_be_active, tag_now_active, event_now_active, event_to_be_active)
    if event_now_active.present?
      event_now_active.duration = Event.time_convert_to_min(
        tag_now_active.updated_at - event_now_active.created_at)
    ...
    unless tag_to_be_active == tag_now_active
      ...
      tag_to_be_active.current_event_id = event_to_be_active
